...
#story-freext>div:nth-of-type(1) {
  ...
  background: url(http://adriaticnews.net/wp-content/uploads/2016/05/women_models_fashion_red_dress_fashion_photography_Wallpaper_1920x1200_www.wallpaperswa.com_.jpg) 50% 0 no-repeat fixed;
}
#story-freext>div:nth-of-type(2) {
  ...
  background: url(http://images.forwallpaper.com/files/thumbs/preview/40/404342__gorgeous-in-red_p.jpg) 50% 0 no-repeat fixed;
}
#bottle>div:nth-of-type(1){
  ...
  background: url('resources/lib/images/paralexbg.jpg') 50% 0 no-repeat fixed;
}
</style>
<body>
<section id="bottle">
